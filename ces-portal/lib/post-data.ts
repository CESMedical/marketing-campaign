...
function toPost(post: DbPost): Post {
  return {
    ...
    images: (post.images ?? undefined) as unknown as string[] | undefined,
    videoRelationship: (post.videoRelationship ?? undefined) as Post['videoRelationship'],
    videoReference: post.videoReference ?? undefined,
    linkedInAccount: post.linkedInAccount ?? undefined,
    linkedInHook: post.linkedInHook ?? undefined,
...
export async function updatePostData(slug: string, updates: Partial<Post>): Promise<Post | undefined> {
  ...
  const post = await prisma.post.update({
    ...
    data: {
      ...
      videoRelationship: updates.videoRelationship,
      videoReference: updates.videoReference,
      linkedInAccount: updates.linkedInAccount,
      linkedInHook: updates.linkedInHook,
      notes: updates.notes,
