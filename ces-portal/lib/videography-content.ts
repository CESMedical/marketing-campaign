...
export const VIDEOGRAPHY_STRATEGY = {
  ...
  description: `CES Medical is producing four long-form interview videos as the primary content asset for the May to July 2026 campaign. The interviews feature Mr Nick Kopsachilis, Mr Kashif Qureshi, Mr Syed Shahid and Elion Hyseni.\n\nEach interview is structured in two parts. Part one is filmed in business attire and covers the consultant or founder perspective on CES Medical, the local community mission, the NHS and private pathway and what makes CES different. Part two is filmed in clinical attire and covers the consultant's specialist expertise, the conditions they treat, the procedures they perform and what patients can expect.\n\nThe clothing change between parts is intentional. It acts as a visual signal to the viewer that the conversation has shifted from the organisational to the clinical. No narration is needed to explain the transition.\n\nEach question is displayed on screen in PP Telegraph font on a deep teal background. There is no presenter or interviewer. The consultant reads the question and answers direct to camera, speaking to one person not a room.\n\nEvery answer is written to stand alone as a 30 to 90 second snippet. After filming, each answer is exported as an individual clip, subtitled and formatted for social use in square format for Instagram and Facebook and landscape format for LinkedIn and YouTube.\n\nThe full long-form interview is edited as a single video per consultant, hosted on YouTube and embedded on each consultant profile page at cesmedical.co.uk.\n\nThe snippets feed directly into the 164-post campaign. Each clip is tagged with the post ID it feeds so the content team can match assets to scheduled posts without ambiguity. The post mapping is documented in the Consultant Interview Scripts card.\n\nB-roll is captured between answers at each filming location: consultant at their desk, walking through the clinic, at diagnostic equipment including the Zeiss IOLMaster 700, and in the theatre environment where applicable.\n\nThis strategy means one filming day per consultant produces assets that serve the website, YouTube, Instagram, Facebook, LinkedIn and the full three-month campaign simultaneously.\n\n─── ON-CAMERA ROLE BOUNDARIES ───\n\nLEONNA — Business Relationship Manager\nOn camera for: Reception and waiting areas. Patient arrival and departure sequences. GP and optometrist relationship content. Operational walk-throughs. Meta content about the campaign and referral relationships. Introducing clinical leads and consultants.\nNot on camera for: Theatre prep. Consultation room explanations. Clinical assessments. Diagnostic equipment demonstrations. Any content that a patient might associate with clinical care delivery.\nPrimary audience for Leonna content: GPs and optometrists considering referring to CES Medical. Patients seeing the non-clinical side of the practice.\n\nANA — Clinical Lead, Chatham\nOn camera for: Clinical environment at Chatham. Theatre preparation. Patient safety processes (sterilisation, equipment checks). What happens clinically during a morning at Chatham. Anything in the clinical zones of Chatham that a consultant is not presenting.\nIntroduced as: "Ana, our clinical lead at Chatham."\n\nLUCY — Clinical Lead, Headcorn\nOn camera for: Clinical environment at Headcorn. Diagnostic suite. Consulting rooms. What happens clinically during a morning at Headcorn. Anything in the clinical zones of Headcorn that a consultant is not presenting.\nIntroduced as: "Lucy, our clinical lead at Headcorn."\n\nCONSULTANTS (Mr Kopsachilis, Mr Qureshi, Mr Shahid)\nOn camera for: All clinical explanation content. Procedure explainers. Consultation process. Clinical environment at their primary locations. Interview content.\nIntroduced as: their full name and title on first appearance in each video.\n\nELION HYSENI — Founder and CEO\nOn camera for: Founder perspective content. Campaign reflections. What CES Medical stands for. Closing messages.`,
  productionNotes: {
    onTheDay: [
